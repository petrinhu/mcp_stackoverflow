...
| CI-1 | 1 | CI | GitHub Actions workflow: Python 3.10-3.14 on Linux, 3.12 on Windows and macOS, `py_compile` + `unittest`. No pip install, no live test | Alta | — | Baixa | ⏳ Pendente | — |
| DOC-AGENTS | 1 | Docs | `AGENTS.md` (agents.md convention): commands, the 5 invariants with rationale, layered architecture, the `TOOLS`+`TOOL_HANDLERS` pitfall, 3.10+ floor, style | Alta | — | Média | ⏳ Pendente | — |
